    ...
    <div className="deposits">
      ...
      <div className="deposits_main">
        ...
        <div className="deposits_boxes">
          <ContentBox
            logo={LicenseLogo}
            heading="Withdraw to your bank card"
          ...
          <ContentBox
            logo={SafetyLogo}
            heading="Withdraw to your bank account"
            text="Wire Transfer is the most wide-spread money transfer method in the world. Transfer money from your Kwakol Markets Wallet to your bank account.We charge $25 banking fees on withdrawals of $5000 and above. "
            transparent
          />
          <ContentBox
            logo={LicenseLogo}
            heading="Withdraw to your crypto wallet"
